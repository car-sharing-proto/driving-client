...
using OpenState = IOpenable.OpenState;
...
public class Door : MonoBehaviour, IOpenable, IInteractable
{
    ...
    private Core.Animation.Vector3_LinearAnimation _openAnimation;
    private Core.Animation.Vector3_LinearAnimation _closeAnimation;
